...
export function CardDefault() {
  ...
  return (
    <div>
      ...
      <h1 className="m-6">Similar projects which were uploaded on our website:</h1>
      <div>
      {dataProject.map((project, index) => (
        <Card key={index} className="w-{full-6} md:w-{full-6} p-4 transition-transform transform hover:scale-105">
          <CardBody>
